...
public class IbanBerechnen {
	...
	public static void main(String[] args) { 
		...
		erzeugeIban(LC, BLZ, KN);
	}

 
	
	private static void erzeugeIban(String LC, String BLZ, String KN) {
		...
		String BBANResult = BBAN + "" + hexLC + "" + hexLC2 + "00";
...
//Scanner sc = new Scanner(System.in);
//System.out.print("Bitte gebe KN ein: ");
//String KN = sc.next();
