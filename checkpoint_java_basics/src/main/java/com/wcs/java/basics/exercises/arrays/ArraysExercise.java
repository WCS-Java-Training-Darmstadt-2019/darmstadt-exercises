...
public class ArraysExercise {
	...
	public static void main(String[] args) {
		// Diese Klasse kompiliert nicht. Bitte schreibe den Code so, dass sie
		// kompiliert.
		// Erstelle die Methode createArray(String wert, int size) die ein Array in der
		// angegebenen Grösse erstellt
	...
	public static String gridAsString(char[][] grid) {
		...
		thisGridAsString = paintBorder(grid, thisGridAsString);
	...
	private static String paintBorder(char[][] grid, String thisGridAsString) {
